...
const ACE_TIMEOUT_MS = 100000; // Vercel fonksiyon süresiyle (config.maxDuration) uyumlu

// Vercel'de (Fluid Compute varsayılan olarak açık) Hobby planı bile 300sn'ye
// kadar fonksiyon süresine izin veriyor; ACE-Step bazen (özellikle
// thinking:true ile) reklam edilen 5-15sn'den daha uzun sürebildiği için
// buradan güvenli bir pay bırakıldı (Blob'a yükleme + olası Edge TTS yedeği
// için de zaman kalsın diye).
